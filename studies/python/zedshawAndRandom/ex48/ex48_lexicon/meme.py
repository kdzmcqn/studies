...
class NoteAutomator:
    ...
    def createNoteAndFolder(self):
        ...
        os.system("notepad " + self.fileName)  # changed 'subl' into 'notepad'
...
if __name__ == "__main__":
    notes = NoteAutomator()
    # gawin ko muna 0 yung argv para sa IDLD. 1 talaga yon
    command = str(sys.argv[1])  # <dir>python script.py [command] [args]
